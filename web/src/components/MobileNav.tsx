...
export default function MobileNav({ onOpenQuoteModal }: MobileNavProps) {
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#0D0304]/95 backdrop-blur-xl border-t border-white/15 px-3 py-2.5 shadow-[0_-10px_30px_rgba(0,0,0,0.8)]">
      <div className="grid grid-cols-3 gap-2 max-w-md mx-auto">
        ...
        >
          <Phone className="w-4 h-4 text-[#9E1218] mb-0.5" />
          <span>CALL</span>
        </a>
        ...
        <button
          ...
          className="flex flex-col items-center justify-center py-2 bg-gradient-to-r from-[#9E1218] to-[#7F0C12] active:bg-white text-white rounded-sm font-mono text-[11px] font-bold shadow-[0_0_15px_rgba(158,18,24,0.4)]"
        >
