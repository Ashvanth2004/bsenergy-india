...
import { ArrowRight, CheckCircle2, MessageSquare, Flame, Cpu, Zap, Factory, Layers } from "lucide-react";
      ...
      <section className="py-16 px-4 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="relative aspect-square w-full bg-[#160608] border border-white/10 rounded-2xl overflow-hidden flex items-center justify-center p-8 shadow-2xl">
