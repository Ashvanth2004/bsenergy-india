...
export default function AboutSection() {
  return (
    <section id="about" className="py-24 bg-[#0D0304] relative overflow-hidden border-b border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-16">
          ...
          <div className="lg:col-span-6 space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight leading-tight">
              ...
              <span className="text-[#9E1218]">Industrial Solutions.</span>
            </h2>
          </div>
          ...
          <div className="lg:col-span-6 space-y-6 text-gray-300 text-base sm:text-lg leading-relaxed">
            ...
            <div className="pt-2">
              <Link
                href="#capability"
                className="group inline-flex items-center gap-3 text-sm font-mono font-bold text-[#9E1218] hover:text-white transition-colors"
              >
        ...
        <div className="relative rounded-lg overflow-hidden border border-white/15 bg-[#160608] shadow-2xl group">
          ...
          <div className="relative h-[340px] sm:h-[450px] w-full">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#0D0304] via-[#0D0304]/40 to-transparent" />
          </div>

          {/* Overlay Overlay Technical Info Box */}
          <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6 bg-[#0D0304]/90 backdrop-blur-md border-t border-white/10">
            <div className="space-y-1">
              <div className="text-xs font-mono font-bold text-[#E2E8F0] uppercase tracking-widest">
            ...
            <div className="flex flex-wrap gap-6 text-xs font-mono text-gray-300">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-[#9E1218]" />
