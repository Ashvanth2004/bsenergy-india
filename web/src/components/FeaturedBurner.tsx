  ...
  return (
    <section className="py-20 bg-[#0D0304] relative overflow-hidden border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="bg-[#160608] border border-[#9E1218]/40 rounded-sm p-8 lg:p-12 relative overflow-hidden shadow-2xl">
          
          {/* Background tech reticle grid */}
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#9E1218]/10 rounded-full blur-3xl pointer-events-none" />

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
            
            {/* Left Column: Large Burner Image */}
            <div className="lg:col-span-6 relative flex items-center justify-center bg-[#0A0203] border border-white/10 p-8 rounded-2xl overflow-hidden">
              ...
              <div className="absolute top-3 left-3 w-3 h-3 border-t-2 border-l-2 border-[#9E1218] rounded-tl-sm" />
              <div className="absolute bottom-3 right-3 w-3 h-3 border-b-2 border-r-2 border-[#9E1218] rounded-br-sm" />
            </div>
            ...
            <div className="lg:col-span-6 space-y-6 relative pl-0 lg:pl-6">
              ...
              <div className="hidden lg:block absolute left-0 top-0 bottom-0 w-[3px] bg-gradient-to-b from-[#9E1218] via-[#9E1218]/40 to-transparent" />

              <div className="space-y-2">
                <div className="tech-label flex items-center gap-2 text-[#CBD5E1]">
                  <Flame className="w-4 h-4 text-[#9E1218]" />
                  FEATURED COMBUSTION SYSTEM
                </div>
                <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">
                  INDUSTRIAL BURNERS
                </h2>
                <div className="text-sm font-mono text-[#E2E8F0] font-semibold">
              ...
              <div className="grid grid-cols-2 gap-4 text-xs font-mono text-gray-300 pt-2 border-t border-white/10">
                <div className="flex items-center gap-2">
                  <span className="text-[#9E1218] font-bold">▪</span> High Thermal Efficiency
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#9E1218] font-bold">▪</span> Continuous Industrial Duty
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#9E1218] font-bold">▪</span> Flame Stability Control
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[#9E1218] font-bold">▪</span> Multi-Fuel Compatibility
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4">
                <button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-[#9E1218] via-[#B81D24] to-[#7F0C12] hover:from-slate-100 hover:to-slate-200 text-white hover:text-black font-mono font-bold text-xs rounded-sm transition-all duration-200 flex items-center gap-2 shadow-[0_0_20px_rgba(158,18,24,0.4)]"
                >
