...
export default function BurnerControllerFeature({ onOpenQuoteModal }: BurnerControllerFeatureProps) {
  return (
    <section className="py-20 bg-[#08101C] relative border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="bg-gradient-to-r from-[#0F1D30] to-[#111827] border border-white/10 rounded-sm p-8 lg:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            {/* Right Image */}
            <div className="lg:col-span-5 relative flex items-center justify-center bg-[#0B1624] border border-white/10 p-6 rounded-sm">
